...
> Ethan 需要的不是一群朋友出去玩——而是一个**犯罪现场的人员配置**。一年的策划，每个名字都经过计算。

**为什么是 6 个人？**

| 人数 | 问题 |
|------|------|
| 3（Ethan + 两个目标） | 两人死后只剩自己，无法自圆其说 |
| 4（+ 替罪羊 Dylan） | 嫌疑过于集中，Dylan 洗清后立刻指向 Ethan |
| 5（+ Sophie） | 可行但偏少，Ethan 嫌疑上升仍然太快 |
| **6（+ Nora）** | **最优解**——两个目标 + 一个替罪羊 + 两个"陪衬" + 自己 = 足够的社交噪音和嫌疑分散空间 |

**逐人选角：**

| 被邀请者 | Ethan 的真实理由 | 表面理由 |
|---------|---------------|---------|
| **Jake** | 目标 1。必须到场 | "兄弟肯定得来" |
| **Amber** | 目标 2。Jake 在她就在，不需要额外操作 | 社交圈自然绑定 |
| **Dylan** | **指定替罪羊**。Dylan 和 Jake 有公开矛盾，性格阴郁孤僻，案发后群体会本能把他当首要嫌疑人。Ethan 在 ch3 也会主动引导怀疑方向 | "多一个人热闹" |
| **Sophie** | **可预测变量**。Sophie 理性守规矩，不会在恐慌时做出意外的事——Ethan 需要群体的行为在他的预判范围内。Sophie 和 Jake 的前任关系还能增加社交复杂性，分散注意力 | "Sophie 人不错" |
| **Nora** | **最安全的第六人**——见下方详述 | "你也来吧" |

**为什么是 Nora？**

Ethan 需要第六个人，但选谁有严格的排除标准：

- ❌ 不能是 Jake/Amber 的密友 → 事后会拼命追查，增加暴露风险
- ❌ 不能是社交能力强的人 → 会主导群体决策，打乱 Ethan 的控场
- ❌ 不能是与 Mia 事件有关联的人 → 可能串联出动机
- ✅ 必须是**社交边缘人** → 不会与任何人结盟对抗他
- ✅ 必须是**被动性格** → 不会主动介入冲突
- ✅ 最好是**有一定感激心理的人** → 感激被邀请 = 不会质疑邀请的理由

Nora 完美符合所有条件：无强社交关系、性格被动内向、在群体中存在感最低、对 Ethan 有信赖感。在 Ethan 的评估中，她是一块透明的背景板——在场但不影响任何事。

**Ethan 不知道的：** Nora 和 Mia 在图书馆有过接触。如果他知道这一点，可能会重新评估邀请她的风险。

**致命失误（戏剧反讽）：**

Ethan 花了一年精心计算每个变量，唯一算错的就是——他选中的"最安全的人"恰恰是唯一能看穿他的人。他把 Nora 的"安静"等同于"无威胁"，没想到安静的人看得最清楚。Nora 的 Lack（被忽视）正是让她成为最危险观察者的原因——**凶手的盲点 = 侦探的超能力**。

> ch8 暴露后的回响："你也来吧"这四个字，是 Ethan 整个计划中最随意的一个决定——也是唯一毁掉他的那个。
...
|--------|---------|---------|--------|------|
| Nora↔Ethan | 学妹信赖学长 | Nora 真心信任他 / Ethan 对 Nora 无恶意，视她为"最安全的第六人"——安静、被动、感激被邀请、不会质疑 | Nora 不知 Ethan 来过 lodge | Ethan 的复仇计划；Ethan 不知 Nora 曾在图书馆接触过 Mia |
